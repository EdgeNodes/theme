...
@section('content-header')
    <h1>Admin Overview<small>A quick glance at your version.</small></h1>
    <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
        ...
        ">
            <div class="box-header with-border">
                <h3 class="box-title">System Version Information</h3>
            </div>
            <div class="box-body">
                @if ($version->isLatestPanel())
                    You are running Pterodactyl Panel version <code>{{ config('app.version') }}</code>. You are running eclipse version "PR1.9E006"!
                @else
